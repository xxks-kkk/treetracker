...
public class Exp2P8JoinTree2QueryK4N10
        extends Query
{
    public Exp2P8JoinTree2QueryK4N10(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(t0k4n10Node, Arrays.asList(asDirectedEdge(t0k4n10Node, t1k4n10Node), asDirectedEdge(t0k4n10Node, t2k4n10Node), asDirectedEdge(t0k4n10Node, t3k4n10Node), asDirectedEdge(t0k4n10Node, t4k4n10Node), asDirectedEdge(t0k4n10Node, t5k4n10Node)), traversalList);
