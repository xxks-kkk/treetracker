 ...
 * |imdb.q2a_company_name(company_id)
 * |imdb_int.title(movie_id,kind_id)
 * |imdb_int.movie_keyword(movie_id,keyword_id)
 * ||imdb.q2a_keyword(keyword_id)
 */
public class Query2aOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query2aOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieKeywordNode, keywordNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, movieKeywordNode)), orderedGraph);
