 ...
 */
public class Query16bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query16bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, movieCompaniesNode, companyNameNode, castInfoNode, nameNode, akaNameNode);
