...
public class Exp2P8JoinTree2QueryK5N10
        extends Query
{
    public Exp2P8JoinTree2QueryK5N10(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(t0k5n10Node, Arrays.asList(asDirectedEdge(t0k5n10Node, t1k5n10Node), asDirectedEdge(t0k5n10Node, t2k5n10Node), asDirectedEdge(t0k5n10Node, t3k5n10Node), asDirectedEdge(t0k5n10Node, t4k5n10Node), asDirectedEdge(t0k5n10Node, t5k5n10Node), asDirectedEdge(t0k5n10Node, t6k5n10Node)), traversalList);
