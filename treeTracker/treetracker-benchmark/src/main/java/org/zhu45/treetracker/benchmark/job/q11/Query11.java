        ...
        extends Query
{
    ...
    {
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q11, null);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q11, null);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q11, null);
        MultiwayJoinNode companyTypeNode = getCompanyTypeInt(JOBQueries.Q11);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q11);
        MultiwayJoinNode movieLinkNode = getMovieLinkInt();
        MultiwayJoinNode linkTypeNode = getLinkTypeInt(JOBQueries.Q11);
