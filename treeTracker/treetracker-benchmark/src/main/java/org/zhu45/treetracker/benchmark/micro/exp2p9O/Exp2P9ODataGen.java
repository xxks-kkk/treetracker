...
import static org.zhu45.treetracker.benchmark.Benchmarks.EXP2P9O_RESULT_STORED_PATH;

/***
 * This class generates relation data in csv form for benchmarking
 */
public class Exp2P9ODataGen
{
    private Exp2P9ODataGen()
    {
    }
...
//    private static int numberOfTuplesInU = 10;
    ...
    private static void generateExp2P9T()
    {
        writeCSV("exp2.9T.csv", List.of(List.of(3, 1), List.of(4, 1)));
    }
    ...
    private static void writeCSV(String fileName, List<List<Integer>> relationInstance)
    {
        ...
        String outputFileName = Paths.get(EXP2P9O_RESULT_STORED_PATH, fileName).toString();
