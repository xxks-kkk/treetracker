 ...
 */
public class Query13cOptJoinTreeOptOrdering
        extends Query
{
    public Query13cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode2, titleNode, movieInfoIdxNode, infoTypeNode1, movieCompaniesNode, companyTypeNode, kindTypeNode, companyNameNode);
