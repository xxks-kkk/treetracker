 ...
 * |imdb.q17a_company_name(company_id)
 * |imdb_int.movie_keyword(movie_id,keyword_id)
 * ||imdb.q17a_keyword(keyword_id)
 * |imdb_int.cast_info(person_id,movie_id,person_role_id,role_id)
 * ||imdb.q17a_name(person_id)
 */
public class Query17aOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query17aOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(castInfoNode, nameNode), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, movieKeywordNode), Pair.of(movieCompaniesNode, castInfoNode)), orderedGraph);
