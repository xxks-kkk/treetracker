 ...
 *
 * ssb.q1p1_date(datekey)
 * |ssb.q1p1_lineorder(lo_orderkey,custkey,partkey,suppkey,datekey)
 */
public class Query1P1OptJoinTreeOptOrdering
        extends Query
{
    public Query1P1OptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
