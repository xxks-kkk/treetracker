...
public class FindOptimalJoinTreeForSSBWithPredicatesAutoGen
{
    @State(Scope.Benchmark)
    public static class BenchState
    {
        ...
        public SSBQueriesFindOptJoinTree jobQueries;
    ...
    public void bench(BenchState state)
    {
        state.query.getPlan().getPlanStatistics().save(state.query.getQueryName(),
                state.query.getAlgorithm(), SSB_RESULT_STORED_PATH);
    }

    public static void main(String[] args)
            throws RunnerException
    {
        benchmark(FindOptimalJoinTreeForSSBWithPredicatesAutoGen.class, SSB_RESULT_STORED_PATH).run();
    }
}
