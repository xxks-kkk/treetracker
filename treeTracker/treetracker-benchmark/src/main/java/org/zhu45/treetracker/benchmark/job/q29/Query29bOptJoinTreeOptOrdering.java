 ...
 */
public class Query29bOptJoinTreeOptOrdering
        extends Query
{
    public Query29bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, completeCastNode, compCastTypeNode1, compCastTypeNode2, movieInfoNode, infoTypeNode1, castInfoNode, charNameNode, roleTypeNode, personInfoNode, infoTypeNode2, nameNode, movieCompaniesNode, companyNameNode, akaNameNode);
