 ...
 */
public class Query20aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query20aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(completeCastNode, compCastTypeNode2, compCastTypeNode1, titleNode, kindTypeNode, castInfoNode, charNameNode, movieKeywordNode, keywordNode, nameNode);
