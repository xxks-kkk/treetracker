...
public class Exp2P8JoinTree1QueryK6N10
        extends Query
{
    public Exp2P8JoinTree1QueryK6N10(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(t0k6n10Node, Arrays.asList(asDirectedEdge(t0k6n10Node, t1k6n10Node), asDirectedEdge(t1k6n10Node, t2k6n10Node), asDirectedEdge(t2k6n10Node, t3k6n10Node), asDirectedEdge(t3k6n10Node, t4k6n10Node), asDirectedEdge(t4k6n10Node, t5k6n10Node), asDirectedEdge(t5k6n10Node, t6k6n10Node), asDirectedEdge(t6k6n10Node, t7k6n10Node)), traversalList);
