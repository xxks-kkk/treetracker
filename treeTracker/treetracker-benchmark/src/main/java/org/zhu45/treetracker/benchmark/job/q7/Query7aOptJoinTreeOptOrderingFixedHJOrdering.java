 ...
 */
public class Query7aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query7aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(personInfoNode, infoTypeNode, nameNode, castInfoNode, titleNode, movieLinkNode, linkTypeNode, akaNameNode);
