 ...
 */
public class Query22dOptJoinTreeOptOrdering
        extends Query
{
    public Query22dOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1, titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieCompaniesNode, companyTypeNode, companyNameNode);
