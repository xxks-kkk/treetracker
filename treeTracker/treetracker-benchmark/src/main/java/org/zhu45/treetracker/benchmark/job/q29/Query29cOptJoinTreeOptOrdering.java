 ...
 */
public class Query29cOptJoinTreeOptOrdering
        extends Query
{
    public Query29cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, completeCastNode, compCastTypeNode1, movieInfoNode, infoTypeNode1, castInfoNode, roleTypeNode, compCastTypeNode2, personInfoNode, infoTypeNode2, nameNode, movieCompaniesNode, companyNameNode, akaNameNode, titleNode, charNameNode);
