 ...
 */
public class Query29cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query29cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, nameNode, titleNode, charNameNode, roleTypeNode, completeCastNode, compCastTypeNode1, compCastTypeNode2, personInfoNode, infoTypeNode2, movieCompaniesNode, companyNameNode, movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1, akaNameNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoNode, infoTypeNode1), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(personInfoNode, infoTypeNode2), Pair.of(completeCastNode, compCastTypeNode1), Pair.of(completeCastNode, compCastTypeNode2), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, charNameNode), Pair.of(castInfoNode, roleTypeNode), Pair.of(castInfoNode, completeCastNode), Pair.of(castInfoNode, personInfoNode), Pair.of(castInfoNode, movieCompaniesNode), Pair.of(castInfoNode, movieKeywordNode), Pair.of(castInfoNode, movieInfoNode), Pair.of(castInfoNode, akaNameNode)), orderedGraph);
