...
public class Query28
        extends Query
{
    public Query28(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinNode compCastTypeNode = getCompCastTypeInt(JOBQueries.Q28, null);
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q28, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q28);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q28, null);
        MultiwayJoinNode companyTypeNode = getCompanyTypeInt(JOBQueries.Q28);
        MultiwayJoinNode movieInfoNode = getMovieInfoInt(JOBQueries.Q28);
        MultiwayJoinNode movieInfoIdxNode = getMovieInfoIdxInt(JOBQueries.Q28, null);
        MultiwayJoinNode infoTypeNode = getInfoTypeInt(JOBQueries.Q28, null);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q28, null);
        MultiwayJoinNode kindTypeNode = getKindTypeInt(JOBQueries.Q28, null);
