 ...
 */
public class Query7bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query7bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(personInfoNode, infoTypeNode, nameNode, akaNameNode, castInfoNode, movieLinkNode, titleNode, linkTypeNode);
