...
public class Query17a
        extends Query
{
    public Query17a(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q17a, null);
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q17a, null);
        MultiwayJoinNode castInfoNode = getCastInfoInt(JOBQueries.Q17a);
        MultiwayJoinNode nameNode = getNameInt(JOBQueries.Q17a);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q17a, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q17a);
