 ...
 */
public class Query9dOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query9dOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, nameNode, roleTypeNode, titleNode, charNameNode, movieCompaniesNode, companyNameNode, akaNameNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieCompaniesNode, companyNameNode), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, roleTypeNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, charNameNode), Pair.of(castInfoNode, movieCompaniesNode), Pair.of(castInfoNode, akaNameNode)), orderedGraph);
