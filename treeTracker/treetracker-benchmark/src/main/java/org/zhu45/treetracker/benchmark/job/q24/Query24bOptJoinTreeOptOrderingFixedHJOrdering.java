 ...
 */
public class Query24bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query24bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, titleNode, infoTypeNode, movieKeywordNode, keywordNode, castInfoNode, charNameNode, movieCompaniesNode, nameNode, companyNameNode, roleTypeNode, akaNameNode);
