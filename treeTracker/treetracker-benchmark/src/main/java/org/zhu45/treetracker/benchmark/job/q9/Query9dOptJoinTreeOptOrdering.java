 ...
 */
public class Query9dOptJoinTreeOptOrdering
        extends Query
{
    public Query9dOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, roleTypeNode, movieCompaniesNode, companyNameNode, akaNameNode, nameNode, titleNode, charNameNode);
