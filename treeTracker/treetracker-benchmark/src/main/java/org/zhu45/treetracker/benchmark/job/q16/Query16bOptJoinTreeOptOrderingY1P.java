 ...
 */
public class Query16bOptJoinTreeOptOrderingY1P
        extends Query
{
    public Query16bOptJoinTreeOptOrderingY1P(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieCompaniesNode, companyNameNode), Pair.of(nameNode, akaNameNode), Pair.of(castInfoNode, nameNode), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieKeywordNode, castInfoNode), Pair.of(movieKeywordNode, titleNode), Pair.of(movieKeywordNode, movieCompaniesNode)), orderedGraph);
