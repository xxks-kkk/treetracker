 ...
 */
public class Query29cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query29cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(completeCastNode, compCastTypeNode2, movieInfoNode, infoTypeNode1, compCastTypeNode1, titleNode, castInfoNode, nameNode, personInfoNode, infoTypeNode2, roleTypeNode, movieCompaniesNode, companyNameNode, movieKeywordNode, keywordNode, charNameNode, akaNameNode);
