...
public class Query2a
        extends Query
{
    public Query2a(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q2a, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q2a);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q2a, null);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q2a, null);
