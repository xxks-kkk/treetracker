 ...
 */
public class Query20aOptJoinTreeOptOrdering
        extends Query
{
    public Query20aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, charNameNode, completeCastNode, compCastTypeNode1, titleNode, kindTypeNode, movieKeywordNode, keywordNode, compCastTypeNode2, nameNode);
