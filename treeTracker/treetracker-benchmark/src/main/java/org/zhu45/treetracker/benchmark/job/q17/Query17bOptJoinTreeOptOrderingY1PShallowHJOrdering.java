 ...
 * |imdb.q17b_name(person_id)
 * |imdb_int.title(movie_id,kind_id)
 * |imdb_int.movie_keyword(movie_id,keyword_id)
 * ||imdb.q17b_keyword(keyword_id)
 * |imdb_int.movie_companies(movie_id,company_id,company_type_id)
 * ||imdb_int.company_name(company_id)
 */
public class Query17bOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query17bOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
