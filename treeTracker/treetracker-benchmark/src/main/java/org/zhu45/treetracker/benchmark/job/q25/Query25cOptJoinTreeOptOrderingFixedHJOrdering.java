 ...
 */
public class Query25cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query25cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, titleNode, movieKeywordNode, keywordNode, castInfoNode, nameNode);
