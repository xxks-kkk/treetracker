 ...
 */
public class Query31cOptJoinTreeOptOrdering
        extends Query
{
    public Query31cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, movieCompaniesNode, companyNameNode, castInfoNode, titleNode, nameNode);
