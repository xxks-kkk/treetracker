 ...
 */
public class Query14aOptJoinTreeOptOrdering
        extends Query
{
    public Query14aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, kindTypeNode, movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2);
