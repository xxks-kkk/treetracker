 ...
 */
public class Query20bOptJoinTreeOptOrdering
        extends Query
{
    public Query20bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, charNameNode, nameNode, completeCastNode, compCastTypeNode2, titleNode, kindTypeNode, compCastTypeNode1, movieKeywordNode, keywordNode);
