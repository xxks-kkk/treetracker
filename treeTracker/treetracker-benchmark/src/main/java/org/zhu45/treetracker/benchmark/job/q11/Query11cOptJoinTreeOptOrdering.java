 ...
 */
public class Query11cOptJoinTreeOptOrdering
        extends Query
{
    public Query11cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieLinkNode, linkTypeNode, movieCompaniesNode, companyNameNode, companyTypeNode, titleNode);
