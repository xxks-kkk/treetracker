 ...
 */
public class Query13bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query13bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(titleNode, kindTypeNode, movieInfoIdxNode, infoTypeNode1, movieCompaniesNode, movieInfoNode, infoTypeNode2, companyNameNode, companyTypeNode);
