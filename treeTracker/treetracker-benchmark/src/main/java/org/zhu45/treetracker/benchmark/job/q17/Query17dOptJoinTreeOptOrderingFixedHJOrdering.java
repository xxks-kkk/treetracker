 ...
 */
public class Query17dOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query17dOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, castInfoNode, nameNode, movieCompaniesNode, companyNameNode, titleNode);
