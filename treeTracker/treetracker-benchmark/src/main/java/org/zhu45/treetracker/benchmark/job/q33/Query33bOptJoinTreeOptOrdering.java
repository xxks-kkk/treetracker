 ...
 */
public class Query33bOptJoinTreeOptOrdering
        extends Query
{
    public Query33bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(titleNode1, kindTypeNode1, movieLinkNode, movieInfoIdxNode1, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, movieCompaniesNode1, companyNameNode1, titleNode2, kindTypeNode2, linkTypeNode, movieCompaniesNode2, companyNameNode2);
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(titleNode1, Arrays.asList(
                ...
                asDirectedEdge(movieInfoIdxNode2, titleNode2),
                asDirectedEdge(titleNode2, kindTypeNode2),
                asDirectedEdge(titleNode2, movieCompaniesNode2),
