 ...
 */
public class Query14bOptJoinTreeOptOrdering
        extends Query
{
    public Query14bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieInfoNode, infoTypeNode1);
