 ...
 */
public class Query30cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query30cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(completeCastNode, compCastTypeNode1, movieInfoNode, infoTypeNode1, compCastTypeNode2, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, titleNode, castInfoNode, keywordNode, nameNode);
