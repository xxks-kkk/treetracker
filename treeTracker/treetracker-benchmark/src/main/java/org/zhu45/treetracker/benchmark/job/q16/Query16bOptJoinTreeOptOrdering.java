 ...
 */
public class Query16bOptJoinTreeOptOrdering
        extends Query
{
    public Query16bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieCompaniesNode, companyNameNode, castInfoNode, akaNameNode, titleNode, nameNode);
