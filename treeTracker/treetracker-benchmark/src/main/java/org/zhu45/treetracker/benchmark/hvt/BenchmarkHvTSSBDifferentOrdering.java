...
import org.zhu45.treetracker.benchmark.ssb.SSBQueriesAutoGen;
import org.zhu45.treetracker.benchmark.ssb.SSBQueriesFindOptJoinTree;
...
/**
 * For SSB, we will use the same ordering for all the algorithms: TTJ, HJ, Yannakakis, and LIP. This benchmark
 * is deprecated and should not be used. GenerateBenchmarkStatisticsReport cannot process the data generated from this file.
 */
@Deprecated
...
public class BenchmarkHvTSSBDifferentOrdering
{
    @State(Scope.Benchmark)
    ...
    {
        benchmark(BenchmarkHvTSSBDifferentOrdering.class, SIMPLE_COST_MODEL_RESULT_WITH_PREDICATES_STORED_PATH).run();
    }
}
