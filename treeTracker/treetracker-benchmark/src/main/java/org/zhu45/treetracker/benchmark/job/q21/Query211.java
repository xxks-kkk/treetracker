...
public class Query211
        extends Query
{
    public Query211(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q21, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q21);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q21, null);
        MultiwayJoinNode companyTypeNode = getCompanyTypeInt(JOBQueries.Q21);
        MultiwayJoinNode movieInfoNode = getMovieInfoInt(JOBQueries.Q21);
        MultiwayJoinNode movieLinkNode = getMovieLinkInt();
        MultiwayJoinNode linkTypeNode = getLinkTypeInt(JOBQueries.Q21);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q21, null);
