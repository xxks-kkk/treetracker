...
public class Query16a
        extends Query
{
    public Query16a(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q16a, null);
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q16a, null);
        MultiwayJoinNode castInfoNode = getCastInfoInt(JOBQueries.Q16a);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q16a);
        MultiwayJoinNode nameNode = getNameInt(JOBQueries.Q16a);
        MultiwayJoinNode akaNameNode = getAkaNameInt(JOBQueries.Q16a);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q16a, null);
