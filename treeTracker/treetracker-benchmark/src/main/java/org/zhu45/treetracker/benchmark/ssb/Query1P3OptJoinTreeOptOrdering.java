 ...
 *
 * ssb.q1p3_date(datekey)
 * |ssb.q1p3_lineorder(lo_orderkey,custkey,partkey,suppkey,datekey)
 */
public class Query1P3OptJoinTreeOptOrdering
        extends Query
{
    public Query1P3OptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
