...
public class CastInfoPattern3
        extends Query
{
    public CastInfoPattern3(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode castInfoNode = getCastInfoInt(JOBQueries.NOPREDICATE);
        MultiwayJoinNode akaNameNode = getAkaNameInt(JOBQueries.NOPREDICATE);
        MultiwayJoinNode nameNode = getNameInt(JOBQueries.NOPREDICATE);
        MultiwayJoinNode charNameNode = getCharNameInt(JOBQueries.NOPREDICATE);

        MultiwayJoinOrderedGraph orderedGraph = getMultiwayJoinOrderedGraph(Arrays.asList(
                asEdge(castInfoNode, charNameNode),
                asEdge(castInfoNode, akaNameNode),
                asEdge(akaNameNode, nameNode)), castInfoNode);
