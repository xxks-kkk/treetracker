...
public class BenchmarkYvTJOBCostModel4Weak
{
    @State(Scope.Benchmark)
    public static class BenchState
    {
        ...
        public void setUp()
        {
            factory = new CostModelFactory(jobQueries, CostModel4Weak.class, postgresJdbcClientSupplier.get());
    ...
    {
        CostModel costModel = state.factory.get();
        createCostStatisticsJson(state.query, costModel, COST_MODEL_4_WITH_PREDICATES_RESULT_STORED_PATH);
    }

    public static void main(String[] args)
            throws RunnerException
    {
        benchmark(BenchmarkYvTJOBCostModel4Weak.class, COST_MODEL_4_WITH_PREDICATES_RESULT_STORED_PATH).run();
    }
}
