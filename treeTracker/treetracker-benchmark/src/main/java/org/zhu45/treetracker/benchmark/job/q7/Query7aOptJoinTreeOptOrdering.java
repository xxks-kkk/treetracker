 ...
 */
public class Query7aOptJoinTreeOptOrdering
        extends Query
{
    public Query7aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, personInfoNode, movieLinkNode, infoTypeNode, linkTypeNode, titleNode, nameNode, akaNameNode);
