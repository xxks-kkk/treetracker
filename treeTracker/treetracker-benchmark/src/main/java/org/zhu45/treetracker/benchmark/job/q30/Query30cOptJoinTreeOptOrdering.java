 ...
 */
public class Query30cOptJoinTreeOptOrdering
        extends Query
{
    public Query30cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1, completeCastNode, compCastTypeNode2, compCastTypeNode1, movieInfoIdxNode2, infoTypeNode2, castInfoNode, nameNode, titleNode);
