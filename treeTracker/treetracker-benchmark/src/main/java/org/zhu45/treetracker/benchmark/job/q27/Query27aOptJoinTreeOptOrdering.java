 ...
 */
public class Query27aOptJoinTreeOptOrdering
        extends Query
{
    public Query27aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieLinkNode, linkTypeNode, completeCastNode, compCastTypeNode2, compCastTypeNode1, movieCompaniesNode, companyTypeNode, companyNameNode, movieInfoNode, titleNode);
