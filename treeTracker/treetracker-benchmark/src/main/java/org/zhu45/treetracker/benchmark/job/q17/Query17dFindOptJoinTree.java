 ...
 */
public class Query17dFindOptJoinTree
        extends Query
{
    public Query17dFindOptJoinTree(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        Pair<Plan, List<Operator>> pair = createPhysicalPlanFromJoinOrdering(getJoinOrderingFromNodes(List.of(movieKeywordNode, keywordNode, castInfoNode, nameNode, movieCompaniesNode, companyNameNode, titleNode)));
