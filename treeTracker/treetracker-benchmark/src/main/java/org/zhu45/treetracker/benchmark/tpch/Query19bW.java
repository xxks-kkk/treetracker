...
public class Query19bW
        extends Query
{
    public Query19bW(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode partNode = getPart(TPCHQueries.Q19bW);
        MultiwayJoinNode lineItemNode = getLineitem(TPCHQueries.Q19bW);
