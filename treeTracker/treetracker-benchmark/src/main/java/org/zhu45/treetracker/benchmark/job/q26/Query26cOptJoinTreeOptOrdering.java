 ...
 */
public class Query26cOptJoinTreeOptOrdering
        extends Query
{
    public Query26cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, charNameNode, completeCastNode, compCastTypeNode1, compCastTypeNode2, titleNode, kindTypeNode, movieInfoIdxNode, infoTypeNode, movieKeywordNode, keywordNode, nameNode);
