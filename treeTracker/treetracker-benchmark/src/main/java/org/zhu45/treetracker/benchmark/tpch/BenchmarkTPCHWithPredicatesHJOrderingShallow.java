...
public class BenchmarkTPCHWithPredicatesHJOrderingShallow
{
    @State(Scope.Benchmark)
    public static class BenchStateTTJ
    {
        @SuppressWarnings("checkstyle:AnnotationUseStyle")
        @Param({"TTJHP", "TTJHP_NO_NG", "TTJHP_NO_DP", "TTJHP_VANILLA"})
    ...
    {
        benchmark(BenchmarkTPCHWithPredicatesHJOrderingShallow.class,
                TPCH_WITH_PREDICATES_RESULT_SQLITE_ORDERING_STORED_PATH).run();
    }
}
