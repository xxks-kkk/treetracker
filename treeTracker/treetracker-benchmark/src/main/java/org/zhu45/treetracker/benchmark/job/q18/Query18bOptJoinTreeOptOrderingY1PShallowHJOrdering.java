 ...
 */
public class Query18bOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query18bOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoIdxNode2, infoTypeNode2), Pair.of(castInfoNode, nameNode), Pair.of(movieInfoNode, titleNode), Pair.of(movieInfoNode, infoTypeNode1), Pair.of(movieInfoNode, castInfoNode), Pair.of(movieInfoNode, movieInfoIdxNode2)), orderedGraph);
