 ...
 * |imdb.q16a_title(movie_id,kind_id)
 * ||imdb_int.movie_keyword(movie_id,keyword_id)
 * |||imdb.q16a_keyword(keyword_id)
 * |imdb_int.name(person_id)
 * ||imdb_int.aka_name(person_id)
 * |imdb_int.movie_companies(movie_id,company_id,company_type_id)
 * ||imdb.q16a_company_name(company_id)
 */
public class Query16aOptJoinTreeOptOrderingY1P
        extends Query
{
    public Query16aOptJoinTreeOptOrderingY1P(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieKeywordNode, keywordNode), Pair.of(nameNode, akaNameNode), Pair.of(titleNode, movieKeywordNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, movieCompaniesNode)), orderedGraph);
