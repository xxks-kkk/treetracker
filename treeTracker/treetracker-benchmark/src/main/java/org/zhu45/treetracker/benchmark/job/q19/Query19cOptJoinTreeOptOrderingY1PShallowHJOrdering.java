 ...
 */
public class Query19cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query19cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, titleNode, nameNode, charNameNode, roleTypeNode, movieCompaniesNode, companyNameNode, movieInfoNode, infoTypeNode, akaNameNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoNode, infoTypeNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, charNameNode), Pair.of(castInfoNode, roleTypeNode), Pair.of(castInfoNode, movieCompaniesNode), Pair.of(castInfoNode, movieInfoNode), Pair.of(castInfoNode, akaNameNode)), orderedGraph);
