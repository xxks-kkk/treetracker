 ...
 */
public class Query11aOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query11aOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieLinkNode, linkTypeNode), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, companyTypeNode), Pair.of(movieCompaniesNode, movieKeywordNode), Pair.of(movieCompaniesNode, movieLinkNode)), orderedGraph);
