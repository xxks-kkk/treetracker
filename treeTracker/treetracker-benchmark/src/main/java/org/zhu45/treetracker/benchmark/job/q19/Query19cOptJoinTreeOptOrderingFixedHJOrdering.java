 ...
 */
public class Query19cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query19cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode, castInfoNode, nameNode, roleTypeNode, titleNode, movieCompaniesNode, companyNameNode, charNameNode, akaNameNode);
