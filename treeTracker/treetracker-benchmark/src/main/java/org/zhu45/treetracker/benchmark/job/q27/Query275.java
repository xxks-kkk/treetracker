...
public class Query275
        extends Query
{
    public Query275(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinOrderedGraph orderedGraph = getMultiwayJoinOrderedGraph(Arrays.asList(
                ...
                asEdge(movieInfoNode, movieLinkNode),
                asEdge(movieLinkNode, linkTypeNode),
                asEdge(movieInfoNode, movieCompaniesNode),
                asEdge(movieCompaniesNode, companyNameNode),
                asEdge(movieCompaniesNode, companyTypeNode)), completeCastNode);
