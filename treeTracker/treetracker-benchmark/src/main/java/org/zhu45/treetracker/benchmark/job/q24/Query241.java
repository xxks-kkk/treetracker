...
public class Query241
        extends Query
{
    public Query241(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode castInfoNode = getCastInfoInt(JOBQueries.Q24);
        MultiwayJoinNode akaNameNode = getAkaNameInt(JOBQueries.Q24a);
        MultiwayJoinNode nameNode = getNameInt(JOBQueries.Q24);
        MultiwayJoinNode roleTypeNode = getRoleTypeInt(JOBQueries.Q24);
        MultiwayJoinNode charNameNode = getCharNameInt(JOBQueries.Q24);
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q24, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q24);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q24, null);
        MultiwayJoinNode movieInfoNode = getMovieInfoInt(JOBQueries.Q24);
        MultiwayJoinNode infoTypeNode = getInfoTypeInt(JOBQueries.Q24, null);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q24, null);
