...
public class Exp2P8JoinTree1QueryK2N10
        extends Query
{
    public Exp2P8JoinTree1QueryK2N10(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(t0k2n10Node, Arrays.asList(asDirectedEdge(t0k2n10Node, t1k2n10Node), asDirectedEdge(t1k2n10Node, t2k2n10Node), asDirectedEdge(t2k2n10Node, t3k2n10Node)), traversalList);
