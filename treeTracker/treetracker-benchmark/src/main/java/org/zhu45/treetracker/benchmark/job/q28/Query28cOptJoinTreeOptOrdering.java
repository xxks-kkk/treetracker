 ...
 */
public class Query28cOptJoinTreeOptOrdering
        extends Query
{
    public Query28cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieCompaniesNode, companyTypeNode, completeCastNode, compCastTypeNode1, movieInfoNode, infoTypeNode1, titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, compCastTypeNode2, companyNameNode);
