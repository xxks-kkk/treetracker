...
public class BenchmarkQ8
{
    ...
    @Benchmark
    public void q8c4Yannakakis()
    {
        benchmarkQuery(JoinOperator.Yannakakis, Query84.class);
    }

    public static void main(String[] args)
            throws RunnerException
    {
        benchmark(BenchmarkQ8.class, JOB_RESULT_STORED_PATH).run();
    }
}
