 ...
 */
public class Query15cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query15cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieKeywordNode, keywordNode), Pair.of(movieInfoNode, infoTypeNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, companyTypeNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, movieInfoNode), Pair.of(movieCompaniesNode, movieKeywordNode), Pair.of(movieCompaniesNode, akaTitleNode)), orderedGraph);
