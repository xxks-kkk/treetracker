 ...
 */
public class Query7cOptJoinTreeOptOrdering
        extends Query
{
    public Query7cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, movieLinkNode, personInfoNode, infoTypeNode, nameNode, linkTypeNode, akaNameNode, titleNode);
