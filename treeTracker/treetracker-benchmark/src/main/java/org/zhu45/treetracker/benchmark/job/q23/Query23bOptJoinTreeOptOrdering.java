 ...
 */
public class Query23bOptJoinTreeOptOrdering
        extends Query
{
    public Query23bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode, completeCastNode, compCastTypeNode, titleNode, kindTypeNode, movieCompaniesNode, companyTypeNode, companyNameNode);
