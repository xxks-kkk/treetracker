 ...
 *
 * ssb.q3p4_customer(custkey)
 * |ssb_int.lineorder(lo_orderkey,custkey,partkey,suppkey,datekey)
 * ||ssb.q3p4_supplier(suppkey)
 * ||ssb.q3p4_date(datekey)
 */
public class Query3P4OptJoinTreeOptOrdering
        extends Query
{
    public Query3P4OptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
