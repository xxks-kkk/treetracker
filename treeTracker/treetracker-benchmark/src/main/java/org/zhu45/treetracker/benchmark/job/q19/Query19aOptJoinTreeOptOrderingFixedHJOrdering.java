 ...
 */
public class Query19aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query19aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, movieInfoNode, infoTypeNode, titleNode, castInfoNode, nameNode, charNameNode, akaNameNode, roleTypeNode);
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(movieCompaniesNode, Arrays.asList(
                ...
                asDirectedEdge(castInfoNode, roleTypeNode)), traversalList);
