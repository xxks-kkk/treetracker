 ...
 */
public class Query31cOptJoinTreeOptOrderingY1P
        extends Query
{
    public Query31cOptJoinTreeOptOrderingY1P(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, movieKeywordNode, keywordNode, movieInfoNode, castInfoNode, movieInfoIdxNode2, titleNode, infoTypeNode1, infoTypeNode2, nameNode);
