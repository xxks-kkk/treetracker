 ...
 */
public class Query16aOptJoinTreeOptOrdering
        extends Query
{
    public Query16aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, titleNode, akaNameNode, movieKeywordNode, keywordNode, movieCompaniesNode, companyNameNode, nameNode);
