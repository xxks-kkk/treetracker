 ...
 */
public class Query24aOptJoinTreeOptOrdering
        extends Query
{
    public Query24aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode, castInfoNode, roleTypeNode, nameNode, movieCompaniesNode, companyNameNode, titleNode, akaNameNode, charNameNode);
