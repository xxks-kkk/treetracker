 ...
 */
public class Query10WOptJoinTreeOptOrdering
        extends Query
{
    public Query10WOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(customerNode, ordersNode, nationNode, lineItemNode);
