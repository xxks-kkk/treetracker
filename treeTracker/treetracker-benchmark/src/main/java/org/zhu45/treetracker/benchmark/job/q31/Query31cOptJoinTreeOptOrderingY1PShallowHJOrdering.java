 ...
 *
 * imdb.q31c_movie_info(movie_id,info_type_id)
 * |imdb.q31c_info_type1(info_type_id)
 * |imdb_int.title(movie_id,kind_id)
 * |imdb.q31c_movie_info_idx2(movie_id,info_type_id2)
 * ||imdb.q31c_info_type2(info_type_id2)
 * |imdb_int.movie_keyword(movie_id,keyword_id)
 * ||imdb.q31c_keyword(keyword_id)
 * |imdb_int.movie_companies(movie_id,company_id,company_type_id)
 * ||imdb.q31c_company_name(company_id)
 * |imdb.q31c_cast_info(person_id,movie_id,person_role_id,role_id)
 * ||imdb_int.name(person_id)
 */
public class Query31cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query31cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, titleNode, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, keywordNode, movieCompaniesNode, companyNameNode, castInfoNode, nameNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(castInfoNode, nameNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieInfoIdxNode2, infoTypeNode2), Pair.of(movieInfoNode, infoTypeNode1), Pair.of(movieInfoNode, titleNode), Pair.of(movieInfoNode, movieInfoIdxNode2), Pair.of(movieInfoNode, movieKeywordNode), Pair.of(movieInfoNode, movieCompaniesNode), Pair.of(movieInfoNode, castInfoNode)), orderedGraph);
