        ...
        implements QueryEnum
{
    ...
    static {
        for (Exp2P9Queries c : values()) {
            switch (c) {
                case Exp2P9Query0P:
                    map.put(c.val, Exp2P9Query0P.class);
                    break;
                case Exp2P9Query1P:
                    map.put(c.val, Exp2P9Query1P.class);
                    break;
                case Exp2P9Query2P:
                    map.put(c.val, Exp2P9Query2P.class);
                    break;
                case Exp2P9Query3P:
                    map.put(c.val, Exp2P9Query3P.class);
                    break;
                case Exp2P9Query4P:
                    map.put(c.val, Exp2P9Query4P.class);
                    break;
                case Exp2P9Query5P:
                    map.put(c.val, Exp2P9Query5P.class);
                    break;
                case Exp2P9Query6P:
                    map.put(c.val, Exp2P9Query6P.class);
                    break;
                case Exp2P9Query7P:
                    map.put(c.val, Exp2P9Query7P.class);
                    break;
                case Exp2P9Query8P:
                    map.put(c.val, Exp2P9Query8P.class);
                    break;
                case Exp2P9Query9P:
                    map.put(c.val, Exp2P9Query9P.class);
                    break;
                case Exp2P9Query10P:
                    map.put(c.val, Exp2P9Query10P.class);
                    break;
                case Exp2P9Query20P:
                    map.put(c.val, Exp2P9Query20P.class);
                    break;
                case Exp2P9Query30P:
                    map.put(c.val, Exp2P9Query30P.class);
                    break;
                case Exp2P9Query40P:
                    map.put(c.val, Exp2P9Query40P.class);
                    break;
                case Exp2P9Query50P:
                    map.put(c.val, Exp2P9Query50P.class);
                    break;
                case Exp2P9Query60P:
                    map.put(c.val, Exp2P9Query60P.class);
                    break;
                case Exp2P9Query70P:
                    map.put(c.val, Exp2P9Query70P.class);
                    break;
                case Exp2P9Query80P:
                    map.put(c.val, Exp2P9Query80P.class);
                    break;
                case Exp2P9Query90P:
                    map.put(c.val, Exp2P9Query90P.class);
                    break;
                case Exp2P9Query100P:
                    map.put(c.val, Exp2P9Query100P.class);
                    break;
            }
        }
    }
    ...
    private Exp2P9Queries(String s)
    {
        val = s;
    }
