 ...
 */
public class Query8WFindOptJoinTree
        extends Query
{
    public Query8WFindOptJoinTree(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        Pair<Plan, List<Operator>> pair = createPhysicalPlanFromJoinOrdering(getJoinOrderingFromNodes(List.of(nationNode, regionNode, customerNode, ordersNode, lineItemNode, partNode, supplierNode, nationNode2)));
