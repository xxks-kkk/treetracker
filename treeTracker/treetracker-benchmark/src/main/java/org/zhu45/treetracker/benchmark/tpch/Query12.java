        ...
        extends Query
{
    ...
    {
        MultiwayJoinNode ordersNode = getOrders(TPCHQueries.Q12);
        MultiwayJoinNode lineItemNode = getLineitem(TPCHQueries.Q12);

        List<QueryGraphEdge> edgeLists = Arrays.asList(
                asQueryGraphEdge(ordersNode, lineItemNode));
