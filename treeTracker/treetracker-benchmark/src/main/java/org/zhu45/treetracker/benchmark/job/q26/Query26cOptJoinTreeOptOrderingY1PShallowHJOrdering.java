 ...
 */
public class Query26cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query26cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieKeywordNode, keywordNode), Pair.of(movieInfoIdxNode, infoTypeNode), Pair.of(completeCastNode, compCastTypeNode2), Pair.of(completeCastNode, compCastTypeNode1), Pair.of(titleNode, kindTypeNode), Pair.of(castInfoNode, charNameNode), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, completeCastNode), Pair.of(castInfoNode, movieInfoIdxNode), Pair.of(castInfoNode, movieKeywordNode)), orderedGraph);
