 ...
 */
public class Query30cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query30cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoNode, infoTypeNode1), Pair.of(movieInfoIdxNode2, infoTypeNode2), Pair.of(movieKeywordNode, keywordNode), Pair.of(castInfoNode, nameNode), Pair.of(completeCastNode, compCastTypeNode1), Pair.of(completeCastNode, compCastTypeNode2), Pair.of(completeCastNode, titleNode), Pair.of(completeCastNode, castInfoNode), Pair.of(completeCastNode, movieKeywordNode), Pair.of(completeCastNode, movieInfoIdxNode2), Pair.of(completeCastNode, movieInfoNode)), orderedGraph);
