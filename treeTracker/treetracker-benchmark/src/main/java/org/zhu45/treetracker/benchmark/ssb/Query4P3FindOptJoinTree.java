...
public class Query4P3FindOptJoinTree
        extends Query
{
    public Query4P3FindOptJoinTree(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        Pair<Plan, List<Operator>> pair = createPhysicalPlanFromPostgresPlan(Paths.get(SSB_UPDATED_POSTGRES_PLAN_STORED_PATH, "updated_4P3.json").toString(), List.of(lineOrderNode.getSchemaTableName(), customerNode.getSchemaTableName(), supplierNode.getSchemaTableName(), dateNode.getSchemaTableName(), partNode.getSchemaTableName()));
