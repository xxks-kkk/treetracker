 ...
 */
public class Query18bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query18bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoIdxNode2, infoTypeNode2, movieInfoNode, infoTypeNode1, titleNode, castInfoNode, nameNode);
