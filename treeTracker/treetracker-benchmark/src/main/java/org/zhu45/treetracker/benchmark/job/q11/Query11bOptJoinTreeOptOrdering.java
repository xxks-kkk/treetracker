 ...
 */
public class Query11bOptJoinTreeOptOrdering
        extends Query
{
    public Query11bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, movieLinkNode, linkTypeNode, movieCompaniesNode, companyTypeNode, companyNameNode);
