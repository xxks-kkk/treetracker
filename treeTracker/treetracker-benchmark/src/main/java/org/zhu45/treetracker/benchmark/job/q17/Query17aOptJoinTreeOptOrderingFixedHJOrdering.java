 ...
 */
public class Query17aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query17aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, movieCompaniesNode, companyNameNode, castInfoNode, nameNode);
