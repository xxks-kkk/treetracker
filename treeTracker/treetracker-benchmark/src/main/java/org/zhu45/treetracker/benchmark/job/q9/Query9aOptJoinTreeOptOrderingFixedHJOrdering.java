 ...
 */
public class Query9aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query9aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, titleNode, castInfoNode, nameNode, roleTypeNode, akaNameNode, charNameNode);
