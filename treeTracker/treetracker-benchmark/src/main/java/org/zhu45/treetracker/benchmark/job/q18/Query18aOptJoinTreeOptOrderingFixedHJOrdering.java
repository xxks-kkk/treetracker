...
public class Query18aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query18aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoIdxNode2, infoTypeNode2, castInfoNode, nameNode, movieInfoNode, infoTypeNode1, titleNode);
