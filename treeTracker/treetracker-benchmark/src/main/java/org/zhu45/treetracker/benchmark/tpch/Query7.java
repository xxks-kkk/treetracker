...
public class Query7
        extends Query
{
    public Query7(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode customerNode = getCustomer(TPCHQueries.Q7);
        MultiwayJoinNode ordersNode = getOrders(TPCHQueries.Q7);
        MultiwayJoinNode lineItemNode = getLineitem(TPCHQueries.Q7);
        MultiwayJoinNode supplierNode = getSupplier(TPCHQueries.Q7);
        MultiwayJoinNode nationNode = getNation(TPCHQueries.Q7, null);

        MultiwayJoinOrderedGraph orderedGraph = getMultiwayJoinOrderedGraph(Arrays.asList(
                asEdge(lineItemNode, supplierNode),
