 ...
 */
public class Query22dOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query22dOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieCompaniesNode, companyNameNode, movieKeywordNode, companyTypeNode, keywordNode);
