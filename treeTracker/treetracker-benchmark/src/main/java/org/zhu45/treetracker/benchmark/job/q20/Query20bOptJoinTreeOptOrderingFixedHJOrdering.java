 ...
 */
public class Query20bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query20bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(completeCastNode, compCastTypeNode1, compCastTypeNode2, titleNode, kindTypeNode, castInfoNode, nameNode, charNameNode, movieKeywordNode, keywordNode);
