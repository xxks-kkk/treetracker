 ...
 */
public class Query19dOptJoinTreeOptOrdering
        extends Query
{
    public Query19dOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode, castInfoNode, roleTypeNode, movieCompaniesNode, companyNameNode, akaNameNode, nameNode, titleNode, charNameNode);
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(movieInfoNode, Arrays.asList(
                ...
                asDirectedEdge(akaNameNode, nameNode),
