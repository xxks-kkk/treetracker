 ...
 */
public class Query11dOptJoinTreeOptOrdering
        extends Query
{
    public Query11dOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieLinkNode, linkTypeNode, movieCompaniesNode, companyTypeNode, companyNameNode, titleNode);
