 ...
 */
public class Query27cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query27cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieKeywordNode, keywordNode), Pair.of(movieLinkNode, linkTypeNode), Pair.of(completeCastNode, compCastTypeNode1), Pair.of(completeCastNode, compCastTypeNode2), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, companyTypeNode), Pair.of(movieCompaniesNode, completeCastNode), Pair.of(movieCompaniesNode, movieLinkNode), Pair.of(movieCompaniesNode, movieKeywordNode), Pair.of(movieCompaniesNode, movieInfoNode)), orderedGraph);
