 ...
 */
public class Query9bOptJoinTreeOptOrderingY1P
        extends Query
{
    public Query9bOptJoinTreeOptOrderingY1P(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, nameNode, roleTypeNode, akaNameNode, movieCompaniesNode, titleNode, charNameNode, companyNameNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieCompaniesNode, companyNameNode), Pair.of(nameNode, akaNameNode), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, movieCompaniesNode), Pair.of(castInfoNode, roleTypeNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, charNameNode)), orderedGraph);
