...
import static org.zhu45.treetracker.benchmark.Benchmarks.SSB_POSTGRES_RESULT_STORED_PATH;
...
public class BenchmarkSSBPostgresPlansShallow
{
    @State(Scope.Benchmark)
    public static class BenchStateHJ
    {
        ...
        @SuppressWarnings("checkstyle:AnnotationUseStyle")
        @Param({"Query1P1FindOptJoinTree", "Query1P2FindOptJoinTree", "Query1P3FindOptJoinTree", "Query2P1FindOptJoinTree", "Query2P2FindOptJoinTree", "Query2P3FindOptJoinTree",
                "Query3P1FindOptJoinTree", "Query3P2FindOptJoinTree", "Query3P3FindOptJoinTree", "Query3P4FindOptJoinTree", "Query4P1FindOptJoinTree", "Query4P2FindOptJoinTree",
                "Query4P3FindOptJoinTree"})
    ...
    {
        benchmark(BenchmarkSSBPostgresPlansShallow.class, SSB_POSTGRES_RESULT_STORED_PATH).run();
    }
}
