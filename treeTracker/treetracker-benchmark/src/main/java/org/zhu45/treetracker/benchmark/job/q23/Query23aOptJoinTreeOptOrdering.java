 ...
 */
public class Query23aOptJoinTreeOptOrdering
        extends Query
{
    public Query23aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, movieInfoNode, keywordNode, titleNode, kindTypeNode, completeCastNode, compCastTypeNode, movieCompaniesNode, companyTypeNode, infoTypeNode, companyNameNode);
