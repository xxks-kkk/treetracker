 ...
 */
public class Query27cOptJoinTreeOptOrdering
        extends Query
{
    public Query27cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieLinkNode, linkTypeNode, completeCastNode, compCastTypeNode1, compCastTypeNode2, movieCompaniesNode, companyTypeNode, companyNameNode, movieInfoNode, titleNode);
