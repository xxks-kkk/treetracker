 ...
 * <p>
 * tpch.q19bw_lineitem(orderkey,partkey,suppkey)
 * |tpch.q19bw_part(partkey)
 */
public class Query19bWOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query19bWOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
