 ...
 */
public class Query31bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query31bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, movieKeywordNode, keywordNode, movieInfoNode, titleNode, castInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, nameNode);
