 ...
 */
public class Query12bOptJoinTreeOptOrdering
        extends Query
{
    public Query12bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, titleNode, movieInfoIdxNode2, infoTypeNode2, movieCompaniesNode, companyTypeNode, companyNameNode);
