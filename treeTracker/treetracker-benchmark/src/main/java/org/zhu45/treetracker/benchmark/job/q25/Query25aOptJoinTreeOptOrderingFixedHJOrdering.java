 ...
 */
public class Query25aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query25aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, castInfoNode, nameNode, titleNode, movieKeywordNode, keywordNode);
