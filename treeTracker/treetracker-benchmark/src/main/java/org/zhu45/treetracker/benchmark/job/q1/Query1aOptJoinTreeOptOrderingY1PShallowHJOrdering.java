 ...
 */
public class Query1aOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query1aOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoIdxNode, infoTypeNode), Pair.of(movieCompaniesNode, companyTypeNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, movieInfoIdxNode)), orderedGraph);
