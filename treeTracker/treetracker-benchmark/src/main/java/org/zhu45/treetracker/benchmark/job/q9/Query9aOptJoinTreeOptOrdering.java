 ...
 */
public class Query9aOptJoinTreeOptOrdering
        extends Query
{
    public Query9aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, nameNode, roleTypeNode, movieCompaniesNode, companyNameNode, akaNameNode, titleNode, charNameNode);
