 ...
 */
public class Query29aOptJoinTreeOptOrdering
        extends Query
{
    public Query29aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, titleNode, completeCastNode, compCastTypeNode1, compCastTypeNode2, movieInfoNode, infoTypeNode1, castInfoNode, roleTypeNode, charNameNode, personInfoNode, infoTypeNode2, nameNode, movieCompaniesNode, companyNameNode, akaNameNode);
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(movieKeywordNode, Arrays.asList(
                ...
                asDirectedEdge(titleNode, completeCastNode),
