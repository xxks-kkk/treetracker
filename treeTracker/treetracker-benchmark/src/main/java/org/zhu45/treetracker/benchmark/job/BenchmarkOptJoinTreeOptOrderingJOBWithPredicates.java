...
public class BenchmarkOptJoinTreeOptOrderingJOBWithPredicates
{
    @State(Scope.Benchmark)
    public static class BenchState
    {
        @Param({"TTJHP", "HASH_JOIN", "TTJHP_NO_NG"})
        public JoinOperator joinOperator;
        @SuppressWarnings("checkstyle:AnnotationUseStyle")
        @Param({"Q2bOptJoinTreeOptOrdering"})
    ...
    {
        benchmark(BenchmarkOptJoinTreeOptOrderingJOBWithPredicates.class, JOB_WITH_PREDICATES_RESULT_STORED_PATH).run();
    }
}
