 ...
 */
public class Query22cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query22cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, movieInfoNode, infoTypeNode1, titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, keywordNode, companyTypeNode);
