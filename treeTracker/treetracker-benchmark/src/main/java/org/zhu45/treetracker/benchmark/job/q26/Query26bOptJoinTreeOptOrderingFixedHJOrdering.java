 ...
 */
public class Query26bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query26bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoIdxNode, infoTypeNode, completeCastNode, titleNode, kindTypeNode, compCastTypeNode2, movieKeywordNode, compCastTypeNode1, castInfoNode, charNameNode, keywordNode, nameNode);
