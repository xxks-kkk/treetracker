 ...
 */
public class Query16aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query16aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, titleNode, companyNameNode, movieKeywordNode, keywordNode, castInfoNode, nameNode, akaNameNode);
