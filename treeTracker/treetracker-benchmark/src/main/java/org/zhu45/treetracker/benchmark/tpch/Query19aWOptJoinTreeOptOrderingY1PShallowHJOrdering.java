 ...
 * <p>
 * tpch.q19aw_lineitem(orderkey,partkey,suppkey)
 * |tpch.q19aw_part(partkey)
 */
public class Query19aWOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query19aWOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
