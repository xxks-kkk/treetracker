...
import static org.zhu45.treetracker.benchmark.Benchmarks.TPCH_WITH_PREDICATES_RESULT_POSTGRES_RESULT_STORED_PATH;
...
public class BenchmarkTPCHPostgresPlansShallow
{
    @State(Scope.Benchmark)
    public static class BenchStateHJ
    {
        ...
        @SuppressWarnings("checkstyle:AnnotationUseStyle")
        @Param({"Query10WFindOptJoinTree", "Query11WFindOptJoinTree", "Query12WFindOptJoinTree", "Query14WFindOptJoinTree", "Query15WFindOptJoinTree",
                "Query16WFindOptJoinTree",
    ...
    {
        benchmark(BenchmarkTPCHPostgresPlansShallow.class,
                TPCH_WITH_PREDICATES_RESULT_POSTGRES_RESULT_STORED_PATH).run();
    }
}
