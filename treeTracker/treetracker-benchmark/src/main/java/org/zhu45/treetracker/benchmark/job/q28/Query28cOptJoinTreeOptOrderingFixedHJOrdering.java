 ...
 */
public class Query28cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query28cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(completeCastNode, compCastTypeNode2, compCastTypeNode1, movieCompaniesNode, movieInfoNode, infoTypeNode1, titleNode, companyNameNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, companyTypeNode, keywordNode);
