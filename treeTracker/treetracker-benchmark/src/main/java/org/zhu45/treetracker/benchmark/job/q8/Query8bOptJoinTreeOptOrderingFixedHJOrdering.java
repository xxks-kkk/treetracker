 ...
 */
public class Query8bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query8bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, titleNode, castInfoNode, roleTypeNode, companyNameNode, nameNode, akaNameNode);
