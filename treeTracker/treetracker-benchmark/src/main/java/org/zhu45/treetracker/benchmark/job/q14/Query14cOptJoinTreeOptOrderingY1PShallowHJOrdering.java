 ...
 */
public class Query14cOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query14cOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, titleNode, infoTypeNode1, kindTypeNode, movieKeywordNode, keywordNode, movieInfoIdxNode2, infoTypeNode2);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoIdxNode2, infoTypeNode2), Pair.of(movieKeywordNode, keywordNode), Pair.of(titleNode, kindTypeNode), Pair.of(movieInfoNode, titleNode), Pair.of(movieInfoNode, infoTypeNode1), Pair.of(movieInfoNode, movieKeywordNode), Pair.of(movieInfoNode, movieInfoIdxNode2)), orderedGraph);
