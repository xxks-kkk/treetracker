...
public class Query17b
        extends Query
{
    public Query17b(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q17b, null);
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q17b, null);
        MultiwayJoinNode castInfoNode = getCastInfoInt(JOBQueries.Q17b);
        MultiwayJoinNode nameNode = getNameInt(JOBQueries.Q17b);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q17b, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q17b);
