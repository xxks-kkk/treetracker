        ...
        extends Query
{
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        Pair<Plan, List<Operator>> pair = createPhysicalPlanFromJoinOrdering(getJoinOrderingFromNodes(List.of(movieCompaniesNode, companyNameNode, movieInfoNode, infoTypeNode1, titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, keywordNode, companyTypeNode)));
