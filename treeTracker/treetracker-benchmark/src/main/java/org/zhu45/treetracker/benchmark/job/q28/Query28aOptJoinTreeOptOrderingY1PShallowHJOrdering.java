 ...
 */
public class Query28aOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query28aOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, titleNode, companyNameNode, companyTypeNode, kindTypeNode, completeCastNode, compCastTypeNode1, compCastTypeNode2, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoNode, infoTypeNode1), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieInfoIdxNode2, infoTypeNode2), Pair.of(completeCastNode, compCastTypeNode1), Pair.of(completeCastNode, compCastTypeNode2), Pair.of(titleNode, kindTypeNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, companyTypeNode), Pair.of(movieCompaniesNode, completeCastNode), Pair.of(movieCompaniesNode, movieInfoIdxNode2), Pair.of(movieCompaniesNode, movieKeywordNode), Pair.of(movieCompaniesNode, movieInfoNode)), orderedGraph);
