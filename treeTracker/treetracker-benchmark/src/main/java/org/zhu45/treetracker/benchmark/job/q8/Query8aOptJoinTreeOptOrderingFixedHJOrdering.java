 ...
 */
public class Query8aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query8aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, castInfoNode, nameNode, titleNode, roleTypeNode, akaNameNode);
