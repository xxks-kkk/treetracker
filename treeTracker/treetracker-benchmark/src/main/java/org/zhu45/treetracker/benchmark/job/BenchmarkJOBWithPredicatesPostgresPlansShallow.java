...
import static org.zhu45.treetracker.benchmark.Benchmarks.JOB_WITH_PREDICATES_RESULT_POSTGRES_RESULT_STORED_PATH;
...
public class BenchmarkJOBWithPredicatesPostgresPlansShallow
{
    @State(Scope.Benchmark)
    public static class BenchStateTTJ
    {
        @SuppressWarnings("checkstyle:AnnotationUseStyle")
        @Param({"TTJHP", "TTJHP_VANILLA", "TTJHP_NO_NG", "TTJHP_NO_DP"})
    ...
    {
        benchmark(BenchmarkJOBWithPredicatesPostgresPlansShallow.class,
                JOB_WITH_PREDICATES_RESULT_POSTGRES_RESULT_STORED_PATH).run();
    }
}
