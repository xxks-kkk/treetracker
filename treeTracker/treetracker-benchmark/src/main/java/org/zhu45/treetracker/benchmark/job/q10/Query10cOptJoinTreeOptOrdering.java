 ...
 */
public class Query10cOptJoinTreeOptOrdering
        extends Query
{
    public Query10cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, companyTypeNode, castInfoNode, roleTypeNode, titleNode, charNameNode);
