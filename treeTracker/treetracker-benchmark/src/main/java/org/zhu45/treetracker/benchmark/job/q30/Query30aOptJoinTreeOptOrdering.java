 ...
 */
public class Query30aOptJoinTreeOptOrdering
        extends Query
{
    public Query30aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1, completeCastNode, compCastTypeNode2, compCastTypeNode1, movieInfoIdxNode2, infoTypeNode2, castInfoNode, titleNode, nameNode);
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(movieKeywordNode, Arrays.asList(
                ...
                asDirectedEdge(completeCastNode, titleNode)), traversalList);
