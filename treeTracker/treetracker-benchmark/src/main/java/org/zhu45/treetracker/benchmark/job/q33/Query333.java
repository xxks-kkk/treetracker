...
import static org.zhu45.treetracker.benchmark.job.JOBQueries.Q33;
import static org.zhu45.treetracker.common.Edge.asEdge;

public class Query333
        extends Query
{
    public Query333(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(Q33, null);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(Q33, null);
        MultiwayJoinNode titleNode = getTitleInt(Q33, null);
        MultiwayJoinNode linkTypeNode = getLinkTypeInt(Q33);
        MultiwayJoinNode movieInfoIdxNode = getMovieInfoIdxInt(Q33, null);
        MultiwayJoinNode kindTypeNode = getKindTypeInt(Q33, null);
        MultiwayJoinNode infoTypeNode = getInfoTypeInt(Q33, null);
