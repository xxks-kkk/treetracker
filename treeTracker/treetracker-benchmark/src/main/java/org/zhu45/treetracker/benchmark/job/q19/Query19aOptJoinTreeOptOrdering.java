 ...
 */
public class Query19aOptJoinTreeOptOrdering
        extends Query
{
    public Query19aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, nameNode, roleTypeNode, movieInfoNode, infoTypeNode, movieCompaniesNode, companyNameNode, titleNode, akaNameNode, charNameNode);
