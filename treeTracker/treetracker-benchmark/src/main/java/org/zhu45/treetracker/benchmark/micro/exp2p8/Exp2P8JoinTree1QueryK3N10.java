...
public class Exp2P8JoinTree1QueryK3N10
        extends Query
{
    public Exp2P8JoinTree1QueryK3N10(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        MultiwayJoinOrderedGraph orderedGraph = new MultiwayJoinOrderedGraph(t0k3n10Node, Arrays.asList(asDirectedEdge(t0k3n10Node, t1k3n10Node), asDirectedEdge(t1k3n10Node, t2k3n10Node), asDirectedEdge(t2k3n10Node, t3k3n10Node), asDirectedEdge(t3k3n10Node, t4k3n10Node)), traversalList);
