 ...
 */
public class Query11dOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query11dOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieLinkNode, linkTypeNode, titleNode, movieKeywordNode, keywordNode, movieCompaniesNode, companyTypeNode, companyNameNode);
