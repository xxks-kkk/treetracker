 ...
 */
public class Query24bOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query24bOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, titleNode, nameNode, roleTypeNode, charNameNode, movieCompaniesNode, companyNameNode, movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode, akaNameNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieInfoNode, infoTypeNode), Pair.of(movieKeywordNode, keywordNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(castInfoNode, titleNode), Pair.of(castInfoNode, nameNode), Pair.of(castInfoNode, roleTypeNode), Pair.of(castInfoNode, charNameNode), Pair.of(castInfoNode, movieCompaniesNode), Pair.of(castInfoNode, movieKeywordNode), Pair.of(castInfoNode, movieInfoNode), Pair.of(castInfoNode, akaNameNode)), orderedGraph);
