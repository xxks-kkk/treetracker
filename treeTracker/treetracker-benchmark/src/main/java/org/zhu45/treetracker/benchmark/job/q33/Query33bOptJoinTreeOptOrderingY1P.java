 ...
 */
public class Query33bOptJoinTreeOptOrderingY1P
        extends Query
{
    public Query33bOptJoinTreeOptOrderingY1P(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(titleNode1, movieLinkNode, kindTypeNode1, titleNode2, movieInfoIdxNode1, linkTypeNode, movieCompaniesNode1, movieInfoIdxNode2, movieCompaniesNode2, infoTypeNode2, infoTypeNode1, companyNameNode1, kindTypeNode2, companyNameNode2);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieCompaniesNode2, companyNameNode2), Pair.of(movieInfoIdxNode2, infoTypeNode2), Pair.of(movieCompaniesNode1, companyNameNode1), Pair.of(movieInfoIdxNode1, infoTypeNode1), Pair.of(titleNode2, kindTypeNode2), Pair.of(movieLinkNode, titleNode2), Pair.of(movieLinkNode, movieInfoIdxNode2), Pair.of(movieLinkNode, linkTypeNode), Pair.of(movieLinkNode, movieCompaniesNode2), Pair.of(titleNode1, movieLinkNode), Pair.of(titleNode1, kindTypeNode1), Pair.of(titleNode1, movieInfoIdxNode1), Pair.of(titleNode1, movieCompaniesNode1)), orderedGraph);
