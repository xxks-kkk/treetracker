...
public class Query1510
        extends Query
{
    public Query1510(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    {
        MultiwayJoinNode movieCompaniesNode = getMovieCompaniesInt(JOBQueries.Q15, null);
        MultiwayJoinNode companyNameNode = getCompanyNameInt(JOBQueries.Q15, null);
        MultiwayJoinNode companyTypeNode = getCompanyTypeInt(JOBQueries.Q15);
        MultiwayJoinNode titleNode = getTitleInt(JOBQueries.Q15, null);
        MultiwayJoinNode akaTitleNode = getAkaTitleInt();
        MultiwayJoinNode movieInfoNode = getMovieInfoInt(JOBQueries.Q15);
        MultiwayJoinNode infoTypeNode = getInfoTypeInt(JOBQueries.Q15, null);
        MultiwayJoinNode movieKeywordNode = getMovieKeywordInt();
        MultiwayJoinNode keywordNode = getKeywordInt(JOBQueries.Q15);
        ...
        MultiwayJoinOrderedGraph orderedGraph = getMultiwayJoinOrderedGraph(Arrays.asList(
                ...
                asEdge(movieCompaniesNode, akaTitleNode)), movieCompaniesNode);
