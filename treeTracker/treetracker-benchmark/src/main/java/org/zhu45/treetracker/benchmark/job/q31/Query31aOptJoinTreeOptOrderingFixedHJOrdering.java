 ...
 */
public class Query31aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query31aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, titleNode, movieCompaniesNode, companyNameNode, movieKeywordNode, keywordNode, castInfoNode, nameNode);
