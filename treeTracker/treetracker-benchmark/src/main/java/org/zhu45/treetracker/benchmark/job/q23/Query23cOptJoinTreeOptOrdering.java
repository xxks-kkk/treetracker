 ...
 */
public class Query23cOptJoinTreeOptOrdering
        extends Query
{
    public Query23cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, movieInfoNode, keywordNode, completeCastNode, compCastTypeNode, titleNode, kindTypeNode, movieCompaniesNode, companyTypeNode, infoTypeNode, companyNameNode);
