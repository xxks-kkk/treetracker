 ...
 */
public class Query13dOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query13dOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoIdxNode, infoTypeNode1, titleNode, kindTypeNode, movieCompaniesNode, companyTypeNode, companyNameNode, movieInfoNode, infoTypeNode2);
