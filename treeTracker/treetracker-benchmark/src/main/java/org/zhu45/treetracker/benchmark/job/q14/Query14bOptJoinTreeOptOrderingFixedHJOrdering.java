 ...
 */
public class Query14bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query14bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(titleNode, kindTypeNode, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1);
