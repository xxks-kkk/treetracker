...
public class FindOptimalJoinTreeForJOBWithPredicatesAutoGen
{
    @State(Scope.Benchmark)
    ...
    {
        benchmark(FindOptimalJoinTreeForJOBWithPredicatesAutoGen.class, JOB_WITH_PREDICATES_RESULT_STORED_PATH).run();
    }
}
