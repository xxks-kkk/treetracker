...
public class Query16cOptJoinTreeOptOrdering
        extends Query
{
    public Query16cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, titleNode, nameNode, akaNameNode, movieKeywordNode, keywordNode, movieCompaniesNode, companyNameNode);
