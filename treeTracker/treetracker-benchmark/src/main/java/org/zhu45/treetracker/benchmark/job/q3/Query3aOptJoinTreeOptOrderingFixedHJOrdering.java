 ...
 */
public class Query3aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query3aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(titleNode, movieInfoNode, movieKeywordNode, keywordNode);
