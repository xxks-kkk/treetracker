 ...
 */
public class Query8dOptJoinTreeOptOrdering
        extends Query
{
    public Query8dOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, roleTypeNode, nameNode, akaNameNode, movieCompaniesNode, companyNameNode, titleNode);
