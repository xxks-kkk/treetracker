 ...
 */
public class Query11bOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query11bOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, titleNode, companyNameNode, companyTypeNode, movieLinkNode, linkTypeNode, movieKeywordNode, keywordNode);
        ...
        SemiJoinOrdering semiJoinOrdering = new SemiJoinOrdering(List.of(Pair.of(movieKeywordNode, keywordNode), Pair.of(movieLinkNode, linkTypeNode), Pair.of(movieCompaniesNode, titleNode), Pair.of(movieCompaniesNode, companyNameNode), Pair.of(movieCompaniesNode, companyTypeNode), Pair.of(movieCompaniesNode, movieLinkNode), Pair.of(movieCompaniesNode, movieKeywordNode)), orderedGraph);
