 ...
 */
public class Query23bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query23bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode, titleNode, movieKeywordNode, keywordNode, completeCastNode, compCastTypeNode, movieCompaniesNode, companyTypeNode, kindTypeNode, companyNameNode);
