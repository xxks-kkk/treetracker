 ...
 */
public class Query25cOptJoinTreeOptOrdering
        extends Query
{
    public Query25cOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, castInfoNode, nameNode, titleNode);
