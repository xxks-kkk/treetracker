...
public class FindShallowJoinTreeForJOBWithPredicates
{
    @State(Scope.Benchmark)
    ...
    public void bench(BenchState state)
    {
        state.query.getPlan().getPlanStatistics().save(state.query.getQueryName(),
                state.query.getAlgorithm(), JOB_WITH_PREDICATES_RESULT_SQLITE_ORDERING_STORED_PATH);
    }
    ...
    {
        state.query.getPlan().getPlanStatistics().save(state.query.getQueryName(),
                JoinOperator.Yannakakis, JOB_WITH_PREDICATES_RESULT_SQLITE_ORDERING_STORED_PATH);
    }

    public static void main(String[] args)
            throws RunnerException
    {
        benchmark(FindShallowJoinTreeForJOBWithPredicates.class, JOB_WITH_PREDICATES_RESULT_SQLITE_ORDERING_STORED_PATH).run();
    }
}
