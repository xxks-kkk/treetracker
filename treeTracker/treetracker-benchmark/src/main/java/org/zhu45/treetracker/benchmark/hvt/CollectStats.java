...
import org.zhu45.treetracker.benchmark.job.q6.Query6aOptJoinTreeOptOrderingY1PShallowHJOrdering;
...
/**
 * A test program to collect statististics
 */
public class CollectStats
{
    ...
    {
        run(JoinOperator.Yannakakis1Pass, Query6aOptJoinTreeOptOrderingY1PShallowHJOrdering.class);
    }
}
