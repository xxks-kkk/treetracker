 ...
 */
public class Query17eOptJoinTreeOptOrdering
        extends Query
{
    public Query17eOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieCompaniesNode, companyNameNode, titleNode, castInfoNode, nameNode);
