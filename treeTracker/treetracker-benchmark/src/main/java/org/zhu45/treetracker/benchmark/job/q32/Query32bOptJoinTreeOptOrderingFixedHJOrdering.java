 ...
 */
public class Query32bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query32bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieLinkNode, linkTypeNode, titleNode, movieKeywordNode, keywordNode, titleNode2);
