        ...
        extends Query
{
    ...
    {
        MultiwayJoinNode customerNode = getCustomer(TPCHQueries.Q10);
        MultiwayJoinNode lineItemNode = getLineitem(TPCHQueries.Q10);
        MultiwayJoinNode ordersNode = getOrders(TPCHQueries.Q10);
        MultiwayJoinNode nationNode = getNation(TPCHQueries.Q10, null);
