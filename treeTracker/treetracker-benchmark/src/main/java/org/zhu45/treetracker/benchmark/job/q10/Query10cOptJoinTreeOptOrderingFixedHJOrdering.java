 ...
 */
public class Query10cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query10cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieCompaniesNode, companyNameNode, titleNode, companyTypeNode, castInfoNode, charNameNode, roleTypeNode);
