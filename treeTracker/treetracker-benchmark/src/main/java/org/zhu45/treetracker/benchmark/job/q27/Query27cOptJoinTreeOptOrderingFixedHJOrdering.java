 ...
 */
public class Query27cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query27cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieLinkNode, linkTypeNode, completeCastNode, compCastTypeNode2, compCastTypeNode1, titleNode, movieCompaniesNode, companyNameNode, companyTypeNode, movieKeywordNode, keywordNode, movieInfoNode);
