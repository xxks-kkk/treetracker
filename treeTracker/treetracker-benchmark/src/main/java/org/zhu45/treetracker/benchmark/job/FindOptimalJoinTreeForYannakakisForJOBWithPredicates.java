...
public class FindOptimalJoinTreeForYannakakisForJOBWithPredicates
{
    @State(Scope.Benchmark)
    ...
    {
        benchmark(FindOptimalJoinTreeForYannakakisForJOBWithPredicates.class, JOB_WITH_PREDICATES_RESULT_STORED_PATH).run();
    }
}
