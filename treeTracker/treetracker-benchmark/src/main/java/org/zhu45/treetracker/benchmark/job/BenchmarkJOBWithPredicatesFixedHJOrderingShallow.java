...
public class BenchmarkJOBWithPredicatesFixedHJOrderingShallow
{
    @State(Scope.Benchmark)
...
//    }
    ...
    {
        benchmark(BenchmarkJOBWithPredicatesFixedHJOrderingShallow.class,
                JOB_WITH_PREDICATES_RESULT_SQLITE_ORDERING_STORED_PATH).run();
    }
}
