 ...
 */
public class Query28aOptJoinTreeOptOrdering
        extends Query
{
    public Query28aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, keywordNode, movieCompaniesNode, companyTypeNode, completeCastNode, compCastTypeNode1, movieInfoNode, infoTypeNode1, movieInfoIdxNode2, infoTypeNode2, titleNode, kindTypeNode, compCastTypeNode2, companyNameNode);
