 ...
 */
public class Query30bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query30bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, titleNode, infoTypeNode1, movieKeywordNode, movieInfoIdxNode2, infoTypeNode2, keywordNode, castInfoNode, completeCastNode, compCastTypeNode2, compCastTypeNode1, nameNode);
