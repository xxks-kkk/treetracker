 ...
 */
public class Query30aOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query30aOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, infoTypeNode1, completeCastNode, compCastTypeNode2, titleNode, castInfoNode, nameNode, compCastTypeNode1, movieInfoIdxNode2, infoTypeNode2, movieKeywordNode, keywordNode);
