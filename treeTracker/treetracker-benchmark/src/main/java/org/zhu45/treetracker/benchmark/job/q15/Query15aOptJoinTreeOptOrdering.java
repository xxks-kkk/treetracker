 ...
 */
public class Query15aOptJoinTreeOptOrdering
        extends Query
{
    public Query15aOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieKeywordNode, movieInfoNode, keywordNode, movieCompaniesNode, companyTypeNode, infoTypeNode, companyNameNode, akaTitleNode, titleNode);
