...
public class FindOptimalHJOrderingForSSBWithPredicates
{
    @State(Scope.Benchmark)
    ...
    {
        benchmark(FindOptimalHJOrderingForSSBWithPredicates.class, SSB_RESULT_STORED_PATH).run();
        generateOptimalJoinOrderingCSV(SSB_RESULT_STORED_PATH,
