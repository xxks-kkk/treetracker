 ...
 */
public class Query25bOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query25bOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(movieInfoNode, titleNode, movieKeywordNode, keywordNode, castInfoNode, movieInfoIdxNode2, infoTypeNode2, infoTypeNode1, nameNode);
