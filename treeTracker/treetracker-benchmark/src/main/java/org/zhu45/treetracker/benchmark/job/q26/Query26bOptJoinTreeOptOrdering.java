 ...
 */
public class Query26bOptJoinTreeOptOrdering
        extends Query
{
    public Query26bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, charNameNode, movieInfoIdxNode, completeCastNode, compCastTypeNode1, titleNode, kindTypeNode, movieKeywordNode, keywordNode, compCastTypeNode2, infoTypeNode, nameNode);
