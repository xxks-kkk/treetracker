 ...
 * |imdb.q2d_company_name(company_id)
 * |imdb_int.title(movie_id,kind_id)
 * |imdb_int.movie_keyword(movie_id,keyword_id)
 * ||imdb.q2d_keyword(keyword_id)
 */
public class Query2dOptJoinTreeOptOrderingY1PShallowHJOrdering
        extends Query
{
    public Query2dOptJoinTreeOptOrderingY1PShallowHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
