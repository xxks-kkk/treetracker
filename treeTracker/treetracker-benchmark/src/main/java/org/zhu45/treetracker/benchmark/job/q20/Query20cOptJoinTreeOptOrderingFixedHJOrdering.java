 ...
 */
public class Query20cOptJoinTreeOptOrderingFixedHJOrdering
        extends Query
{
    public Query20cOptJoinTreeOptOrderingFixedHJOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(completeCastNode, compCastTypeNode2, compCastTypeNode1, titleNode, kindTypeNode, movieKeywordNode, keywordNode, castInfoNode, charNameNode, nameNode);
