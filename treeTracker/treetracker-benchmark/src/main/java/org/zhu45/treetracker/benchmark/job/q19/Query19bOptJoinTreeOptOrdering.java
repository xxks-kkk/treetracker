 ...
 */
public class Query19bOptJoinTreeOptOrdering
        extends Query
{
    public Query19bOptJoinTreeOptOrdering(JoinFragmentContext context)
    {
        super(context);
    }
    ...
    protected Pair<Plan, List<Operator>> constructQuery()
    {
        ...
        List<MultiwayJoinNode> traversalList = List.of(castInfoNode, roleTypeNode, titleNode, movieInfoNode, infoTypeNode, nameNode, movieCompaniesNode, companyNameNode, akaNameNode, charNameNode);
