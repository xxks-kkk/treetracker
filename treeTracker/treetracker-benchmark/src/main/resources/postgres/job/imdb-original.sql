...
-- setup Postgres database schemas of IMDB dataset for Join Ordering Benchmark (JOB). We use original JOB schemas.
-- This is for benchmarking JOB on Postgres performance.
...
-- Preventive actions to manually drop all the automatically created indexes. We need to
-- make sure indeed all the indexes are dropped. See "job-postgres.md.html" for the SQL
-- statement on checking it.
BEGIN TRANSACTION;
DROP INDEX public."ix_name_basics_birthYear";
DROP INDEX public."ix_name_basics_deathYear";
DROP INDEX public."ix_name_basics_nconst";
DROP INDEX public."ix_name_basics_ns_soundex";
DROP INDEX public."ix_name_basics_s_soundex";
DROP INDEX public."ix_name_basics_sn_soundex";
DROP INDEX public."ix_title_akas_isOriginalTitle";
DROP INDEX public."ix_title_akas_language";
DROP INDEX public."ix_title_akas_region";
DROP INDEX public."ix_title_akas_t_soundex";
DROP INDEX public."ix_title_akas_titleId";
DROP INDEX public."ix_title_akas_types";
DROP INDEX public."ix_title_basics_isAdult";
DROP INDEX public."ix_title_basics_runtimeMinutes";
DROP INDEX public."ix_title_basics_startYear";
DROP INDEX public."ix_title_basics_t_soundex";
DROP INDEX public."ix_title_basics_tconst";
DROP INDEX public."ix_title_basics_titleType";
DROP INDEX public."ix_title_crew_tconst";
DROP INDEX public."ix_title_episode_parentTconst";
DROP INDEX public."ix_title_episode_tconst";
DROP INDEX public."ix_title_principals_nconst";
DROP INDEX public."ix_title_principals_tconst";
DROP INDEX public."ix_title_ratings_averageRating";
DROP INDEX public."ix_title_ratings_numVotes";
DROP INDEX public."ix_title_ratings_tconst";
COMMIT;