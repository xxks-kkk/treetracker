...
-- instruction: psql -p5432 -d postgres -f treeTracker/treetracker-benchmark/src/main/resources/tpch-abbreviated-s20.sql
BEGIN TRANSACTION;
...
COPY tpch_int.nation_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/nation.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.customer_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/customer.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.lineitem_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/lineitem.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.orders_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/orders.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.part_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/part.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.partsupp_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/partsupp.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.region_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/region.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.supplier_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s20/supplier.tbl' WITH DELIMITER '|' NULL '\N' CSV;
