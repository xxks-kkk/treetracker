...
-- instruction:  psql -p5432 -d postgres -f treeTracker/treetracker-benchmark/src/main/resources/ssb.sql
-- ref:
...
COPY SSB.customer FROM '/home/zeyuanhu/projects/eyalroz-ssb-dbgen/postgres/s1/customer.tbl' WITH DELIMITER '|' NULL AS ''  CSV;
COPY SSB.lineorder FROM '/home/zeyuanhu/projects/eyalroz-ssb-dbgen/postgres/s1/lineorder.tbl' WITH DELIMITER '|' NULL AS ''  CSV;
COPY SSB.part FROM '/home/zeyuanhu/projects/eyalroz-ssb-dbgen/postgres/s1/part.tbl' WITH DELIMITER '|' NULL AS ''  CSV;
COPY SSB.supplier FROM '/home/zeyuanhu/projects/eyalroz-ssb-dbgen/postgres/s1/supplier.tbl' WITH DELIMITER '|' NULL AS ''  CSV;
COPY SSB.date FROM '/home/zeyuanhu/projects/eyalroz-ssb-dbgen/postgres/s1/date.tbl' WITH DELIMITER '|' NULL AS ''  CSV;
