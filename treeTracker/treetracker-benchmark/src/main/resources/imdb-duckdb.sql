...
CREATE  TABLE imdb.comp_cast_type (
                                              subject_id integer NOT NULL,
                                              kind character varying(32) NOT NULL
);

CREATE  TABLE imdb.company_name (
...
CREATE  TABLE imdb.company_type (
                                            company_type_id integer NOT NULL,
                                            kind character varying(32) NOT NULL
);

CREATE  TABLE imdb.complete_cast (
...
CREATE  TABLE imdb.link_type (
                                         link_type_id integer NOT NULL,
                                         link character varying(32) NOT NULL
);

CREATE  TABLE imdb.movie_companies (
                                               id integer NOT NULL,
                                               movie_id integer NOT NULL,
                                               company_id integer NOT NULL,
                                               company_type_id integer NOT NULL,
...
CREATE  TABLE imdb.movie_info_idx (
                                              id integer NOT NULL,
                                              movie_id integer NOT NULL,
                                              info_type_id integer NOT NULL,
                                              info text NOT NULL,
