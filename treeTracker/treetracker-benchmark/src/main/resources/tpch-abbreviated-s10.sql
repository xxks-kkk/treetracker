...
-- instruction: psql -p5432 -d postgres -f treeTracker/treetracker-benchmark/src/main/resources/tpch-abbreviated-s10.sql
BEGIN TRANSACTION;
...
COPY tpch_int.nation_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/nation.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.customer_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/customer.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.lineitem_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/lineitem.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.orders_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/orders.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.part_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/part.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.partsupp_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/partsupp.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.region_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/region.tbl' WITH DELIMITER '|' NULL '\N' CSV;
COPY tpch_int.supplier_tmp FROM '/home/zeyuanhu/projects/tpch-kit/dbgen/postgres/s10/supplier.tbl' WITH DELIMITER '|' NULL '\N' CSV;
