...
/**
 * This is specific for Sort node in Postgres plan.
 */
public class SortNode
        extends PlanNode
{
    private static final OptType NODE_PLAN_NODE_TYPE = OptType.sort;
    private PlanNode childPlanNode;

    public SortNode(PlanNodeId id, PlanNode child, Side side)
    {
        super(id, side);
