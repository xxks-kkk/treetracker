...
/**
 * This is specific for Postgres plan where build hash table appears as a node in the plan.
 */
public class HashNode
        extends PlanNode
{
    private static final OptType NODE_PLAN_NODE_TYPE = OptType.hash;
    private PlanNode childPlanNode;

    public HashNode(PlanNodeId id, PlanNode child, Side side)
    {
        super(id, side);
