...
public class TestTreeTrackerBGJoinOperator
{
    private static final String naturalJoinTable = "TestTreeTrackerBGJoinOperator";
    ...
    private Object[][] testTreeTrackerBGJoinOperatorTestCasesDataProvider()
    {
        return twoDlistTo2DArray(buildAllTestCases(base));
    }

    @ParameterizedTest
    @MethodSource("testTreeTrackerBGJoinOperatorTestCasesDataProvider")
    public void testTreeTrackerBGJoinOperator(Pair<Plan, List<Operator>> pair)
    {
