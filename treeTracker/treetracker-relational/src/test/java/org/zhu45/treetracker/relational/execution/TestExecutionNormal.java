...
public class TestExecutionNormal
{
    private TestingPhysicalPlanBase base;
    private static String naturalJoinTable = "TestExecutionNormal";
    ...
    public void setUp()
    {
        if (checkEnvVariableSet(TREETRACKER_DEBUG)) {
            ...
            Configurator.setAllLevels(TupleBasedNestedLoopJoinOperator.class.getName(), Level.DEBUG);
        }
    ...
    private Object[][] testPhysicalPlanExecutionNormalComplexWrapper()
    {
        return twoDlistTo2DArray(buildAllTestCases(base));
    }

    @ParameterizedTest
    @MethodSource("testPhysicalPlanExecutionNormalComplexWrapper")
    public void testPhysicalPlanExecutionNormalComplex(Pair<Plan, List<Operator>> pair)
    {
