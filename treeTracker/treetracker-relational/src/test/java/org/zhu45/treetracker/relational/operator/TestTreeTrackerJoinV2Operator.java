...
public class TestTreeTrackerJoinV2Operator
{
    ...
    private Object[][] testTreeTrackerJoinV2OperatorTestCasesDataProvider()
    {
        return twoDlistTo2DArray(buildAllTestCases(base));
    }

    @ParameterizedTest
    @MethodSource("testTreeTrackerJoinV2OperatorTestCasesDataProvider")
    public void testTreeTrackerJoinV2Operator(Pair<Plan, List<Operator>> pair)
    {
