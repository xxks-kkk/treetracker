...
from plot.constants import DATA_SOURCE_CSV, ALGORITHMS_TO_PLOT, HJ, TTJ, Yannakakis, COLUMN_RIGHT_BOUND, YannakakisB, \
    Yannakakis1Pass, SQLITE, TTJ_COLOR, Yannakakis1Pass_COLOR, HJ_COLOR
...
def plot_job():
    def bar_plot(ax, data, labels, colors=None, total_width=0.8, single_width=1, legend=True, fontdict=None,
        ...
        if legend:
            ...
            ax.legend(bars, [r'$\mathsf{TTJ}$', r"$\mathsf{HJ}$", r'$\mathsf{YA}$', 'SQLite'], fontsize=13, ncol=4, frameon=False,
    ...
    font = {'family': 'Helvetica',
            'weight': 'bold',
            'size': 10}
    bar_plot(axs[0], data_chunk1, data_chunk1_label, colors=[TTJ_COLOR, HJ_COLOR, Yannakakis1Pass_COLOR], total_width=.7, single_width=1,
             fontdict=font)
    bar_plot(axs[1], data_chunk2, data_chunk2_label, colors=[TTJ_COLOR, HJ_COLOR, Yannakakis1Pass_COLOR], total_width=.7, single_width=1,
             fontdict=font, legend=False)
    bar_plot(axs[2], data_chunk3, data_chunk3_label, colors=[TTJ_COLOR, HJ_COLOR, Yannakakis1Pass_COLOR], total_width=.7, single_width=1,
             fontdict=font, legend=False)
    ...
    filename = "exp1.1-bar-job-sqlite-4.pdf"
