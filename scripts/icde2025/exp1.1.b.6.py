...
def plot_job():
    ...
    data_chunk1_label, data_chunk2_label, data_chunk3_label = labels[:chunk_1_endpoint], labels[
                                                                                         chunk_1_endpoint:chunk_2_endpoint], labels[
                                                                                                                             chunk_2_endpoint:]
    ...
    filename = "exp1.1-bar-job-postgres-6.pdf"
