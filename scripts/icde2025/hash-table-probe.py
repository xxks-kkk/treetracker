...
def process_algorithm(json_data, algorithm):
    def process_ya(json_data):
        ...
        return join_number_of_hash_table_probe

    def process_hj(json_data):
        return json_data['Aggregation Stats']['numberOfHashTableProbe']
...
def job_speedup():
    ...
    plt.ylabel('Num of hash table prob ratio (log scale)', fontdict=font2)
    plt.margins(x=0.01)
    plt.tight_layout()
    filename = 'num-of-hash-table-probe.pdf'
