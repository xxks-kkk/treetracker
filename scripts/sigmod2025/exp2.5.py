...
Bar plot with reduction time % based on sample count
"""
import csv
...
def plot_ssb():
    ...
    conf = {
        DATA_SOURCE_CSV: "exp2p5_TTJHP_profiling_agg.csv",
    }
    queries, agg_data = extract_data_from_agg_csv(conf[DATA_SOURCE_CSV], get_profiling_results_full_path)
    ...
    data_to_plot = dict()
    data_to_plot[TTJ] = reduction_time_percentage_use
