...
The script should be identical to "ablation_study_no_intRow.py" but with only TTJHP, HJ, and Postgres.
"""
...
from plot.constants import DATA_SOURCE_CSV, ALGORITHMS_TO_PLOT, HJ, TTJ, COLUMN_RIGHT_BOUND, Yannakakis1Pass, TTJ_COLOR, \
    ...
    TTJ_VANILLA_COLOR, JOB_POSTGRES_ORDERGING_RESULTS_INTROW_OFF
...
def plot_job():
    def bar_plot(ax, data, labels, colors=None, total_width=0.8, single_width=1, legend=True, fontdict=None,
        ...
        bars = []
        for i, name in enumerate([TTJ, HJ]):
            values = data[name]
        ...
        if legend:
            ...
            ax.legend(bars, [r'$\mathsf{TTJ}$', r'$\mathsf{HJ}$', 'Postgres'], fontsize=13, ncol=6, frameon=False,
    ...
    job_plot = {
        ...
        ALGORITHMS_TO_PLOT: [HJ, TTJ, POSTGRES],
