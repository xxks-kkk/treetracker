...
from icde2025.postgres_perf import process_job_raw_data, process_job_enforced_raw_data
from plot.constants import DATA_SOURCE_CSV, ALGORITHMS_TO_PLOT, HJ, TTJ, COLUMN_RIGHT_BOUND, Yannakakis1Pass, TTJ_COLOR, \
    Yannakakis1Pass_COLOR, HJ_COLOR, POSTGRES, TTJ_NO_NG, TTJ_NO_NG_COLOR, TTJ_VANILLA, TTJ_NO_DP, TTJ_NO_DP_COLOR, \
    TTJ_VANILLA_COLOR
...
def plot_job():
    def bar_plot(ax, data, labels, colors=None, total_width=0.8, single_width=1, legend=True, fontdict=None,
        ...
        bars = []
        for i, name in enumerate([TTJ, TTJ_NO_DP, TTJ_NO_NG, TTJ_VANILLA, HJ, Yannakakis1Pass]):
            values = data[name]
        ...
        if legend:
            ...
            ax.legend(bars, [r'$\mathsf{TTJ}^{dp+ng}$', r'$\mathsf{TTJ}^{ng}$', r'$\mathsf{TTJ}^{dp}$', r'$\mathsf{TTJ}$', r"$\mathsf{HJ}$", r'$\mathsf{YA}$', 'Postgres'], fontsize=13, ncol=7, frameon=False,
    ...
    job_plot = {
        ...
        ALGORITHMS_TO_PLOT: [HJ, TTJ, TTJ_NO_NG, TTJ_NO_DP, TTJ_VANILLA, Yannakakis1Pass, POSTGRES],
    ...
    font = {'family': 'Helvetica',
            'weight': 'bold',
            'size': 10}
    bar_plot(axs[0], data_chunk1, data_chunk1_label, colors=[TTJ_COLOR, TTJ_NO_DP_COLOR, TTJ_NO_NG_COLOR, TTJ_VANILLA_COLOR, HJ_COLOR, Yannakakis1Pass_COLOR], total_width=.7, single_width=1,
             fontdict=font)
    bar_plot(axs[1], data_chunk2, data_chunk2_label, colors=[TTJ_COLOR, TTJ_NO_DP_COLOR, TTJ_NO_NG_COLOR, TTJ_VANILLA_COLOR, HJ_COLOR, Yannakakis1Pass_COLOR], total_width=.7, single_width=1,
             fontdict=font, legend=False)
    bar_plot(axs[2], data_chunk3, data_chunk3_label, colors=[TTJ_COLOR, TTJ_NO_DP_COLOR, TTJ_NO_NG_COLOR, TTJ_VANILLA_COLOR, HJ_COLOR, Yannakakis1Pass_COLOR], total_width=.7, single_width=1,
             fontdict=font, legend=False)
